...
Accounting for ground motion uncertainty in empirical seismic fragility modeling. <br /> Bodenmann, L., Baker J. W., and Stojadinović, B. <br /> <em>Earthquake Spectra </em> 2024 <br /> <a class="btn btn--primary" href="https://doi.org/10.1177/87552930241261486"> <i class="fa fa-file-pdf fa-lg"></i> View at publisher (open access) </a> <a class="btn btn--primary" href="https://github.com/bodlukas/BayesFrag"> <i class="fa fa-code" aria-hidden="true"></i> code</a>
{: .notice--warning}
